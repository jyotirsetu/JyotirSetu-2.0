...
const SITE = {"name":"JyotirSetu","site":"https://jyotirsetu.com","base":"/","trailingSlash":false,"googleSiteVerificationId":null};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"JyotirSetu","template":"%s — JyotirSetu"},"description":"Professional astrology, palmistry & numerology consultations by Astrologer Punita Sharma.","openGraph":{"type":"website","site_name":"JyotirSetu","images":[{"url":"~/assets/images/logo.png","width":1200,"height":628,"alt":"JyotirSetu Logo"}]},"twitter":{"handle":null,"site":null,"cardType":"summary_large_image","images":[{"url":"~/assets/images/logo.png","width":1200,"height":628,"alt":"JyotirSetu Logo"}]}};
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getPermalink as a, getBlogPermalink as b, getAsset as c, getCanonical as d, cleanSlug as e, getFormattedDate as f, getHomePermalink as g, trimSlash as t };
