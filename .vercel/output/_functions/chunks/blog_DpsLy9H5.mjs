...
import { k as AstroError, G as UnknownContentCollectionError, c as createComponent, H as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, J as renderUniqueStylesheet, K as renderScriptElement, O as createHeadAndContent, r as renderComponent } from './astro/server__1NYpXS4.mjs';
import 'kleur/colors';
import * as devalue from 'devalue';
import { e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './permalinks_D-LnMJ_P.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_dU94jSvd.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://jyotirsetu.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CBhLiufD.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_jEgE7PqY.mjs');
